...
const LogoWithoutBg = ({
  ...
  return <div className={`flex items-center justify-center ${className}`}>
      <img src={processedLogoUrl || '/lovable-uploads/8f3ff22e-97df-444d-8b79-c8326ab85ce1.png'} alt="ELANCE Logo" className="w-full h-full object-contain filter drop-shadow-lg" />
    </div>;
};
